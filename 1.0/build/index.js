...
gallery/panel/1.0/lib/main
gallery/panel/1.0/index

*/
KISSY.add('gallery/panel/1.0/lib/main',function(S, Node, UA){
 ...
 * @module panel
 **/
KISSY.add('gallery/panel/1.0/index',function (S, Panel) {
    return Panel;
}, {requires:['./lib/main']});
